from acquire.s2425.vasaloppet import get_results
...
if __name__ == '__main__':
    ...
    for gender in [Gender.male, Gender.female]:
        ...
        Event.vasaloppet.save_df(pl.concat([main_points.select(['first_name', 'last_name', 'gender', 'gender_place', 'age', 'age_advantage_event_points']), nonmain_points]), gender)
